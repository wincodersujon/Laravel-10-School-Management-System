...
class ClassSubjectController extends Controller
{
    ...
    public function insert(Request $request)
    {
        if (!empty($request->subject_id)) {
            ...
            return redirect()->back()->with('error', 'Due to same error please try again');
        }
    ...
    public function update(Request $request)
    {
       ClassSubjectModel::deleteSubject($request->class_id);
        ...
        return redirect('admin/assign_subject/list')->with('success', 'Assigned Subject Updated Successfully');
    }
    //Create delete method than go to ClassSubjectModel and getSingle method
