...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript:;" class="brand-link" style="text-align: center">
        ...
        style="font-weight: bold !important;font-size:20px;">SCHOOL.COM</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'admin') active @endif">
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'class') active @endif">
                        <i class="nav-icon far fa-user"></i>
                        <p>
                           Class
                        </p>
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'subject') active @endif">
                        <i class="nav-icon far fa-user"></i>
                        <p>
                            Subject
                        </p>
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'assign_subject') active @endif">
                        <i class="nav-icon far fa-user"></i>
                        <p>
                           Assign Subject
                        </p>
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'teacher') active @endif">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Dashboard
                        </p>
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'student') active @endif">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Dashboard
                        </p>
                ...
                <li class="nav-item">
                    ...
                    @if (Request::segment(2) == 'parent') active @endif">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Dashboard
                        </p>
